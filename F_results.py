...
- Next you will be given your results and a ✔️ to ✖️ comparison and %
...
''')
    ...
    correct_percent = questions_right / 12
    correct_percent *= 100
    correct_percent = int(correct_percent)

    print("")
    print(f'''You got {questions_right}/12 correct '''
          f'''which is {correct_percent} out 100 percent''')

    show_history = choice_checker("Would you like to see you results: ", yes_no_list, "please enter yes or no as your responce")
